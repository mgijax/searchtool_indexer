 ...
 * 
 */
public class VocabAccIDLuceneDocBuilder extends AbstractLuceneDocBuilder {
    ...
    public static void main(String[] args) {
        ...
        VocabAccIDLuceneDocBuilder builder = new VocabAccIDLuceneDocBuilder();
