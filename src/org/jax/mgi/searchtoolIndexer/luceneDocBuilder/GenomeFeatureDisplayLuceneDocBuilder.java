...
public class GenomeFeatureDisplayLuceneDocBuilder extends AbstractLuceneDocBuilder {
	...
	/*
	 * private String startCoord = ""; private String stopCoord = "";
	 */
	 ...
	 * 
	 * @param name
	 *            - String to set the name field to.
	 */
	 ...
	 * 
	 * @param marker_type
	 *            String to set the marker_type to.
	 */
	 ...
	 * 
	 * @param acc_id
	 *            String to set the accession id to.
	 */

	/*
	 * public void setAcc_id(String acc_id) { if (acc_id != null) { this.acc_id
	 * = acc_id; } else { this.hasError = true; } }
	 */
