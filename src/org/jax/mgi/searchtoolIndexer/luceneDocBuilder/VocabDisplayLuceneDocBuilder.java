...
public class VocabDisplayLuceneDocBuilder extends AbstractLuceneDocBuilder {
    ...
    protected Document prepareDocument() {
        ...
        doc.add(new Field(IndexConstants.COL_MARKER_COUNT,
                this.marker_count, Field.Store.YES, Field.Index.NO));
        
        doc.add(new Field(IndexConstants.COL_ANNOT_COUNT,
                this.annotation_count, Field.Store.YES, Field.Index.NO));
        
        doc.add(new Field(IndexConstants.COL_ANNOT_OBJECTS,
                this.annotation_objects, Field.Store.YES,
                Field.Index.NO));
        
        doc.add(new Field(IndexConstants.COL_ANNOT_OBJECT_TYPE,
                this.annotation_object_type, Field.Store.YES,
                Field.Index.NO));
        ...
        doc.add(new Field("secondary_object_count",
                this.secondary_object_count, Field.Store.YES,
                Field.Index.NO));
        
        doc.add(new Field(IndexConstants.COL_ACC_ID,
                this.acc_id, Field.Store.YES, Field.Index.NO));
        
        doc.add(new Field(IndexConstants.COL_TYPE_DISPLAY,
                this.type_display, Field.Store.YES, Field.Index.NO));
    ...
    public String toString() {
        return "Data: " + this.data + " Database Key: " 
            ...
            + this.child_ids + " Marker Count: " + this.marker_count
            + " Annotation Count: " + this.annotation_count
            + " Annotation Objects: " + this.annotation_objects 
            + " Annotation Object Type: " + this.annotation_object_type
            + " Accession Id: " + this.acc_id;
    }
...
/*    public void appendContents(String data) {
        if (data != null) {
     ...
     * it into "MP", similar conversions occur for "Interpro Domains" and
     * "PIR Superfamily"
     * 
     * @param type
     */
    ...
    /**
     * Returns the marker count. This can likely be removed in a future
    ...
    public String getAnnot_display() {
        ...
        // If its go, how many genes and annotations do we have?            
        ...
        // Interpro is also genes and annotations.
        ...
        // MP is genotypes and annotations.
        ...
        // Else set an error message for that entry.
