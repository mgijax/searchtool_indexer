...
import org.jax.mgi.searchtoolIndexer.luceneDocBuilder.MarkerVocabAccIDLuceneDocBuilder;
...
public class MarkerVocabAccIDGatherer extends DatabaseGatherer {

    // Class Variables

    private MarkerVocabAccIDLuceneDocBuilder builder =
        new MarkerVocabAccIDLuceneDocBuilder();
    ...
    private void doVocabAccessionIDs() 
