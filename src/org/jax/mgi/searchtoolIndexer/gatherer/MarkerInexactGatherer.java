...
import org.jax.mgi.searchtoolIndexer.luceneDocBuilder.MarkerInexactLuceneDocBuilder;
...
public class MarkerInexactGatherer extends DatabaseGatherer {
    ...
    private void doVocabADTerm() throws SQLException, InterruptedException {
        ...
        while (!rs_ad_term.isAfterLast()) {
            ...
            builder.setDisplay_type(providerMap.get(rs_ad_term
                    .getString("vocabName")));
    ...
    private void doVocabADSynonym() throws SQLException, InterruptedException {
        ...
        while (!rs_ad_syn.isAfterLast()) {
            ...
            builder.setDisplay_type(providerMap.get(
                    rs_ad_syn.getString("vocabName")));
    ...
    private void doVocabTerm(String sql) 
        ...
        while (!rs_term.isAfterLast()) {
            ...
            builder.setUnique_key(rs_term.getString("_Term_key")
    ...
    private void doVocabSynonym(String sql) 
        ...
        while (!rs_syn.isAfterLast()) {
            ...
            builder.setUnique_key(rs_syn.getString("_Synonym_key")
                    +IndexConstants.VOCAB_SYNONYM
                    +rs_syn.getString("vocabName"));
            builder.setVocabulary(rs_syn.getString("vocabName"));
            builder
                    .setDisplay_type(providerMap.get(rs_syn.getString("vocabName")));
            builder.setDataType(IndexConstants.VOCAB_SYNONYM);
